...
Route::get('/', [PortalController::class, 'index'])->name('portal.home');
        ...
        Route::prefix('{journal}')->group(function () {
            ...
            Route::middleware(['auth', 'journal.context'])->group(function () {
                ...
                Route::put('/files/{file}/name', [SubmissionFileController::class, 'updateName'])->name('journal.files.update-name');
                Route::get('/files/{file}/info', [SubmissionFileController::class, 'getInformation'])->name('journal.files.info');
                Route::post('/files/{file}/notes', [SubmissionFileController::class, 'addNote'])->name('journal.files.add-note');
