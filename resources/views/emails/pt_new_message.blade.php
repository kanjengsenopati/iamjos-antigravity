...
<div style="background: rgba(0, 0, 0, 0.07); margin: 0 auto">
    <div class="box_content" style="
        ...
        <div style="margin-bottom: 1.25rem">
            ...
            <p style="font-size: 0.75rem; color: black">
            Anda telah menerima pesan baru dari <br>{{ $user->name }}.<br><br> 
            {{ $text_message }}<br><br>
            Silakan cek kotak masuk Anda untuk membaca dan membalas pesan tersebut. Terima kasih atas perhatian dan kerjasamanya.
            </p>
