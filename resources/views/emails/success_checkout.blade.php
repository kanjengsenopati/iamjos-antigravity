@extends('emails.layouts', ['title' => 'Lanjutkan Pembayaran'])
@section('content')
                                                ...
                                                <tr style="border-collapse: collapse">
                                                    <td align="left" style="padding: 0; margin: 0; width: 518px">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <p
                                                                        ...
                                                                        Selamat! Pembelian Anda di NEST GYM telah berhasil
                                                                        pada tanggal {{ date('d/m/Y') }} pukul
                                                                        {{ date('H:i') }} WIB. Yuk, segera lakukan
                                                                        pembayaran agar pembelian Anda tidak dibatalkan.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                "
                                                                    ...
                                                                    <tr>
                                                                        <td class="text_style">Status</td>
                                                                        <td class="badge-warning" align="right">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text_style">Tanggal Pesanan</td>
                                                                        <td class="text_style" align="right">
                                                                            {{ date('d/m/Y H:i') }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text_style">Batas Pembayaran</td>
                                                                        <td class="text_style" align="right">
                                                                            {{ date('d/m/Y H:i', strtotime($transaction->expiry_time)) }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <tr style="border-collapse: collapse">
                                                                <td align="center"
                                                                    style="margin: 0; padding: 32px 10px 48px">
