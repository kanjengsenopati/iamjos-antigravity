        ...
        <div class="mb-17">
            <div class="mb-2 d-flex flex-wrap align-items-center justify-content-between gap-4 border-0 pt-6">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">Daftar Review Produk</span>
                </h3>
            </div>
            <div class="table-responsive">
                <table id="datatable-product" class="table table-hover align-middle table-row-dashed fs-6 gy-5 mb-0">
                    <thead>
