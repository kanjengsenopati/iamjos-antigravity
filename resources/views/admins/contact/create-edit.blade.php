            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header">
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">{{ request()->routeIs('contact.create') ? 'Tambah Kontak' : 'Edit
                            Kontak'
                            }}
                        </h3>
                    </div>
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    request()->routeIs('contact.create') ? route('contact.store') : route('contact.update',
                        @$contact->id) }}">
                        @csrf
                        <x-form.put-method />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <select name="type" id="type"
                                                class="form-select mb-3 mb-lg-0" required>
                                                <option value="">Pilih Tipe Kontak</option>
                                                <option value="email" {{ @$contact->type == 'email' ? 'selected' :
                                                    '' }}>Email</option>
                                                <option value="phone" {{ @$contact->type == 'phone' ? 'selected' :
                                                    '' }}>Telepon</option>
                                                <option value="whatsapp" {{ @$contact->type == 'whatsapp' ? 'selected'
                                                    : '' }}>Whatsapp</option>
                                            </select>
                                        </div>
                                        <!--end::Col-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <!--begin::Col-->
                                        <div class="col-lg-12 fv-row">
                                            <x-form.image-upload label="Icon Kontak" name="icon" :value="@$contact->icon ?? null"
                                                nullable='1' />
                                        </div>
                                        <!--end::Col-->
                                    </div>
