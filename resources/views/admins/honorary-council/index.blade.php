@extends('layouts.master', ['title' => 'Data Dewan Kehormatan', 'main' => 'Dashboard'])
@section('content')
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header mt-4">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('honorary-council.create') }}" class="btn btn-primary btn-sm btn-create">
                        ...
                        <div class="card-body pt-0">
                            <!--begin::Table-->
                            <table id="table-honorary-council"
...
@push('js')
    <script>
        $(document).ready(() => {
            var table = $('#table-honorary-council').DataTable({
                ordering: false,
                processing: true,
                serverSide: true,
                responsive: true,
                searchDelay: 500,
                ajax: "{{ route('honorary-council.index') }}",
                language: {
                    "paginate": {
