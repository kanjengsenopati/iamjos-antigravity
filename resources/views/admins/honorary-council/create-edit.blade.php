@extends('layouts.master', ['main' => 'Data Dewan Kehormatan', 'title' => request()->routeIs('honorary-council.create') ? 'Tambah Dewan Kehormatan' : 'Edit Dewan Kehormatan'])
                    ...
                    <div class="card-header" id="kt_chat_contacts_header">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3">
                                {{ request()->routeIs('honorary-council.create') ? 'Tambah Dewan Kehormatan' : 'Edit Dewan Kehormatan' }}
                            </span>
                        </h3>
                    </div>
                    <div class="card-body pt-5">
                        <x-alert.alert-validation />
                        <form id="honoraryCouncil"
                            action="{{ request()->routeIs('honorary-council.create') ? route('honorary-council.store') : route('honorary-council.update', @$honoraryCouncil->id) }}"
                            ...
                            <div class="fv-row mb-6">
                                <x-form.image-upload label="Foto" maxSize="2MB" name="image" :value="@$honoraryCouncil->image ?? null"
                                    id="image" nullable='1' />
                            </div>
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{ old('name', @$honoraryCouncil->name) }}" placeholder="Masukkan Nama"
                                    required />
                            </div>
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="text" class="form-control" id="position" name="position"
                                    value="{{ old('position', @$honoraryCouncil->position) }}"
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="text" class="form-control" id="position_en" name="position_en"
                                    value="{{ old('position_en', @$honoraryCouncil->position_en) }}"
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('honorary-council.index') }}">
