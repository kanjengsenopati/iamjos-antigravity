@extends('layouts.master', ['title' => 'Riwayat Sauna', 'main' => 'Dashboard'])
@section('content')
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header mt-6">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1">Data Riwayat Sauna</span>
                        </h3>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
