@extends('layouts.master', ['main' => 'Data Tentang Kami', 'title' => 'Informasi'])
            ...
            <div class="col-xl-12">
                <div class="card h-lg-100" id="kt_contacts_main">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <form id="aboutus-information" action="{{ route('aboutus-information.store') }}" method="POST"
                            ...
                            <div>
                                <div class="fv-row mb-6">
                                    <x-form.image-upload label="Gambar" maxSize="2MB" name="image" :value="@$aboutUsInformation->image ?? null"
                                        id="image" nullable='1' />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        value="{{ old('title', @$aboutUsInformation->title) }}" placeholder="Masukkan Judul"
                                        required />
                                </div>
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="text" class="form-control" id="title_en" name="title_en"
                                    value="{{ old('title_en', @$aboutUsInformation->title_en) }}"
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <textarea class="form-control" id="subtitle" name="subtitle" rows="4">{{ old('subtitle', @$aboutUsInformation->subtitle) }}</textarea>
                                </div>
                                <div class="col-md-2 mt-8">
                                    <button type="button" class="btn btn-info btn-sm w-100"
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <textarea class="form-control" id="subtitle_en" name="subtitle_en" rows="4">{{ old('subtitle_en', @$aboutUsInformation->subtitle_en) }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <input type="text" class="form-control" id="button_text" name="button_text"
                                        value="{{ old('button_text', @$aboutUsInformation->button_text) }}"
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="text" class="form-control" id="button_text_en" name="button_text_en"
                                    value="{{ old('button_text_en', @$aboutUsInformation->button_text_en) }}"
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="url" class="form-control" id="link" name="url"
                                    value="{{ old('url', @$aboutUsInformation->url) }}" placeholder="Masukkan Tautan Link"
                                    required />
                            </div>
                            <input type="hidden" name="id" value="{{ old('id', @$aboutUsInformation->id) }}" />
                            {{-- Tombol Aksi --}}
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('aboutus-information.index') }}">
