@extends('layouts.master', ['title' => 'Data Struktur Organisasi BPP', 'main' => 'Dashboard'])
                    ...
                    <div class="card card-flush">
                        <div class="card-header mt-4">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold">Struktur Organisasi BPP</span>
                            </h3>
                            <div class="card-toolbar gap-2">
                                <a href="{{ route('bpp-organization.create') }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus"></i> Tambah Jabatan BPP
                                </a>
                                <a href="{{ route('member.create', ['type' => 'bpp']) }}"
                                    class="btn btn-light-primary btn-sm">
                                    <i class="fa fa-user-plus"></i> Tambah Anggota BPP
                                </a>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <h6 class="dropdown-header">Jabatan BPP</h6>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('bpp-organization.export.positions') }}">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="{{ route('bpp-organization.template.positions') }}">
                                        ...
                                        <li>
                                            <h6 class="dropdown-header">Anggota BPP</h6>
                                        </li>
                                        <li><a class="dropdown-item" href="{{ route('bpp-organization.export.members') }}">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="{{ route('bpp-organization.template.members') }}">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <ul class="nav nav-tabs nav-line-tabs mb-5 fs-6">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#tab-positions">Jabatan BPP</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#tab-members">Anggota BPP</a>
                                </li>
                            </ul>
...
@push('js')
    <script>
        $(function() {
            ...
            $('#table-positions').DataTable({
                ...
                responsive: true,
                searchDelay: 500,
                ajax: "{{ route('bpp-organization.index') }}?type=position",
                language: dtLang,
                columns: [{
                        data: null,
                        orderable: false,
            ...
            $('#table-members').DataTable({
                ...
                responsive: true,
                searchDelay: 500,
                ajax: "{{ route('bpp-organization.index') }}?type=member",
                language: dtLang,
                columns: [{
                        data: null,
                        orderable: false,
    ...
    <div class="modal fade" id="importPositionModal" tabindex="-1" aria-labelledby="importPositionModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('bpp-organization.import.positions') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="importPositionModalLabel">Import Data Jabatan BPP</h5>
                            ...
                            <div class="form-text">
                                <small>
                                    ...
                                    <ul class="mt-2">
                                        ...
                                        <li>Jabatan Induk dan Nama Anggota harus sudah ada di sistem BPP</li>
    ...
    <div class="modal fade" id="importMemberModal" tabindex="-1" aria-labelledby="importMemberModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('bpp-organization.import.members') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="importMemberModalLabel">Import Data Anggota BPP</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div class="form-text">
                                <small>
                                    ...
                                    <ul class="mt-2">
                                        ...
                                        <li>Anggota akan otomatis ditandai sebagai type BPP</li>
                                        <li>Maksimal file 2MB</li>
                                    </ul>
                                </small>
                            </div>
