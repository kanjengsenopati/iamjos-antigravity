@extends('layouts.master', ['title' => 'Data PHRI Berbagi', 'main' => 'Dashboard'])
@section('content')
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header mt-4">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                {{-- <span class="card-label fw-bold fs-3 mb-1">Data Benefit</span> --}}
                            </h3>
                            <div class="card-toolbar">
                                <a href="{{ route('benefit.create') }}" class="btn btn-primary btn-sm btn-create">
                            ...
                            <table id="table-benefit"
                                ...
                                <thead>
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">SubJudul</th>
