...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center overflow-x-hidden">
    ...
    <div id="kt_app_root">
        ...
        <div class="py-20 position-absolute w-100 mx-auto d-flex justify-content-center d-lg-none">
            <img src="{{ asset('assets/media/logos/logo.png') }}" class="h-logo" alt="" />
        </div>
        ...
        <div class="row align-items-center h-100 px-0">
                ...
                <div class="d-flex flex-column flex-center rounded-4">
                    ...
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            <!--begin::Form-->
                            <form class="form input_form" novalidate="novalidate" id="kt_sign_in_form"
                                action="{{ route('authenticate') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Heading-->
                                <div class="mb-8">
                                    <img src="{{ asset('assets/media/logos/logo.png') }}"
                                        class="h-logo d-none d-lg-block" alt="" />
                                    <!--begin::Title-->
                                    <h1 class="text-dark title fw-bold mb-2">Masuk</h1>
                                    <!--end::Title-->
                                    <!--begin::Subtitle-->
                                    <p class="text-gray-500 fw-semibold">
                                        Kelola konten website PHRI dengan mudah — berita, agenda, keanggotaan, dan
                                        publikasi dalam satu dashboard.
                                    </p>
                                ...
                                <div class="fv-row mb-6">
                                    ...
                                    <input id="password" type="password" placeholder="Password" name="password"
                                        autocomplete="off"
                                        class="form-control position-relative bg-transparent w-100" />
                                    <button type="button"
                                        class="bg-transparent position-absolute end-0 btn-password py-0 border-0"
                                        onclick="togglePasswordVisibility()">
                                        <img id="passwordToggleIcon"
                                            src="{{ asset('assets/media/icons/eye-slash.svg') }}" alt="">
                                    </button>
                                    <!--end::Password-->
                                </div>
                                <!--end::Input group=-->
                                ...
                                <div class="text-end">
                                    <a href="{{ route('forgot-password', ['type' => 'ADMIN']) }}"
                                        class="text-primary fw-medium">Lupa password?</a>
                                </div>
                                <!--end::Forgot Password-->
                                <!--begin::Wrapper-->
            ...
            <div class="col-6 h-100 px-0 d-none d-lg-block">
                <img src="{{ asset('assets/media/bg/bg-login.jpg') }}" class="w-100 h-100 object-fit-cover"
                    alt="" />
            </div>
            <!--end::Content-->
        </div>
