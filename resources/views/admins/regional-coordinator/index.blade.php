@extends('layouts.master', ['title' => 'Data Koordinator Wilayah', 'main' => 'Dashboard'])
@section('content')
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header mt-4">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('regional-coordinator.create') }}"
                        ...
                        <div class="card-body pt-0">
                            <!--begin::Table-->
                            <table id="table-regional-coordinator"
...
@push('js')
    <script>
        $(document).ready(() => {
            var table = $('#table-regional-coordinator').DataTable({
                ordering: false,
                processing: true,
                serverSide: true,
                responsive: true,
                searchDelay: 500,
                ajax: "{{ route('regional-coordinator.index') }}",
                language: {
                    "paginate": {
