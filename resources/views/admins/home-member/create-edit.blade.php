@extends('layouts.master', ['main' => 'Data Keanggotaan', 'title' => request()->routeIs('home-member.create') ? 'Tambah Keanggotaan' : 'Edit Keanggotaan'])
@section('content')
    <!--begin::Container-->
                ...
                <div class="card h-lg-100" id="kt_contacts_main">
                    ...
                    <div class="card-header" id="kt_chat_contacts_header">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span
                                class="card-label fw-bold fs-3">{{ request()->routeIs('home-member.create') ? 'Tambah Keanggotaan' : 'Edit Keanggotaan' }}</span>
                        </h3>
                        <!--end::Card title-->
                    </div>
                    <!--end::Card header-->
                    ...
                    <div class="card-body pt-5">
                        ...
                        <form id="home-member"
                            action="{{ request()->routeIs('home-member.create') ? route('home-member.store') : route('home-member.update', @$homeMember->id) }}"
                            method="POST" enctype="multipart/form-data">
                            @csrf
                            <x-form.put-method />
                            <div class="fv-row mb-6">
                                <x-form.image-upload label="Logo" maxSize="2MB" name="image" :value="@$homeMember->image ?? null"
                                    nullable='1' />
                            </div>
                            <div class="fv-row mb-6">
                                <!--begin::Label-->
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="number" class="form-control" id="order" name="order"
                                    value="{{ old('order', @$homeMember->order) }}" placeholder="Masukkan Urutan" />
                                <!--end::Input-->
                            </div>
                            <!--end::Separator-->
