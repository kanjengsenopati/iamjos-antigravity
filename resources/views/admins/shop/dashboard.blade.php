                        ...
                        <div class="d-flex flex-wrap d-grid gap-5 px-9 mb-5">
                            ...
                            <div class="me-md-2">
                                ...
                                <div class="d-flex mb-2">
                                    <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2" id="total_transaction">{{ $totalTransaction ?? 0 }}</span>
                                </div>
                                <!--begin::Description-->
                            ...
                            <div class="border-start-dashed border-start border-gray-300 px-5 ps-md-10 pe-md-7 me-md-5">
                                ...
                                <div class="d-flex mb-2">
                                    ...
                                    <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2" id="total_omset">
                                        {{ number_format($totalTurnover ?? 0, 0, ',', '.') }}
                                    </span>
                                </div>
                                <!--end::Statistics-->
                                <!--begin::Description-->
...
<script>
    $(document).ready(() => {
        ...
        $('#status, #gym_place_id').on('change', function() {
            table.ajax.reload();
            updateByDateStatus();
        });
    })
