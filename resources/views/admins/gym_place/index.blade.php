@extends('layouts.master', ['title' => 'Tempat Gym', 'main' => 'Dashboard'])
@section('content')
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Tempat Gym</span>
                            </h3>
                            <!--end::Card title-->
                            <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                ...
                                <a type="button" class="btn btn-sm btn-primary btn-create"
                                    href="{{ route('gym-place.create') }}">
                                    <i class="fa fa-plus"></i>Tempat Gym</a>
                                <!--end::Button-->
                            </div>
                            <!--end::Card toolbar-->
                        </div>
