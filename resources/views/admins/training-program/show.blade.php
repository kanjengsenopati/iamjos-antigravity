@extends('layouts.master', ['title' => 'Detail Program Latihan'])
@section('content')
                ...
                <div class="card card-flush">
                    <div class="card-header mt-6">
                        <h3 class="card-title align-items-start flex-column">
                            <a href="{{ route('training-program.index') }}" class="btn btn-icon btn-active-color-primary me-3">
...
<script>
    $(document).ready(function() {
        $('#datatable-program-details').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "{{ route('training-program.show', $program->id) }}",
                type: 'GET'
            },
            language: {
                "paginate": {
