@extends('layouts.master', ['title' => 'Kategori Movement'])
                ...
                <div class="card h-lg-100">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('category-movement.create') }}" class="btn btn-primary">Tambah Kategori</a>
                        </div>
                    </div>
...
<script>
    $(document).ready(() => {
        var table = $('#categories-table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "{{ route('category-movement.index') }}",
            },
            language: {
                "paginate": {
