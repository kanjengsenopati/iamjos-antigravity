@extends('layouts.master', ['main' => 'Data Booking Ina', 'title' => 'Informasi'])
                    ...
                    <div class="card-header" id="kt_chat_contacts_header">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3">
                                Informasi Booking Ina
                            </span>
                        </h3>
                    </div>
                    <div class="card-body pt-5">
                        <x-alert.alert-validation />
                        <form id="aboutus-information" action="{{ route('booking-ina.store') }}" method="POST"
                            ...
                            <div>
                                <div class="fv-row mb-6">
                                    <x-form.image-upload label="Gambar" maxSize="2MB" name="image" :value="@$bookingIna->image ?? null"
                                        id="image" nullable='1' />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        value="{{ old('title', @$bookingIna->title) }}" placeholder="Masukkan Judul"
                                        required />
                                </div>
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="text" class="form-control" id="title_en" name="title_en"
                                    value="{{ old('title_en', @$bookingIna->title_en) }}"
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <textarea class="form-control" id="subtitle" name="subtitle" rows="4">{{ old('subtitle', @$bookingIna->subtitle) }}</textarea>
                                </div>
                                <div class="col-md-2 mt-8">
                                    <button type="button" class="btn btn-info btn-sm w-100"
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <textarea class="form-control" id="subtitle_en" name="subtitle_en" rows="4">{{ old('subtitle_en', @$bookingIna->subtitle_en) }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <input type="text" class="form-control" id="button_text" name="button_text"
                                        value="{{ old('button_text', @$bookingIna->button_text) }}"
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="text" class="form-control" id="button_text_en" name="button_text_en"
                                    value="{{ old('button_text_en', @$bookingIna->button_text_en) }}"
                            ...
                            <div class="fv-row mb-6">
                                ...
                                <input type="url" class="form-control" id="link" name="url"
                                    value="{{ old('url', @$bookingIna->url) }}" placeholder="Masukkan Tautan Link"
                                    required />
                            </div>
                            <input type="hidden" name="id" value="{{ old('id', @$bookingIna->id) }}" />
                            {{-- Tombol Aksi --}}
