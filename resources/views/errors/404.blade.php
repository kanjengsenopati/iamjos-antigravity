...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | IamJOS</title>
...
<body class="min-h-screen flex items-center justify-center p-6 selection:bg-blue-500/30">
    ...
    <div class="relative z-10 w-full max-w-[580px] glass-card rounded-[40px] p-12 md:p-16 text-center shadow-2xl transition-all duration-500 hover:shadow-blue-500/5">
        ...
        <div class="mb-10 flex items-center justify-center">
            ...
            {{-- Badge "ERROR 404" telah dihapus sesuai permintaan --}}
        </div>

        <!-- Big 404 -->
        <div class="mb-6">
            <h1 class="text-[120px] font-black text-white leading-none tracking-tighter opacity-90">404</h1>
        </div>
        ...
        <div class="mb-10">
            ...
            <p class="text-slate-400 text-lg leading-relaxed max-w-sm mx-auto">
                Maaf, halaman atau jurnal yang Anda cari tidak tersedia. Mungkin URL yang Anda masukkan salah atau halaman telah dipindahkan.
            </p>
        </div>
        ...
        <div class="mt-4">
            <button onclick="window.history.back()" 
                ...
                <span class="relative z-10">Halaman Sebelumnya</span>
