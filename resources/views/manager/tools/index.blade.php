            ...
            <div class="relative">
                ...
                <nav class="relative flex overflow-x-auto no-scrollbar">
                    <button @click="activeTab = 'import'"
                        ...
                        Import / Export
                        <div x-show="activeTab === 'import'" class="absolute -bottom-[2px] inset-x-0 h-[3px] bg-white z-30"></div>
                    </button>
                    <button @click="activeTab = 'permissions'"
                        ...
                        Permissions
                        <div x-show="activeTab === 'permissions'" class="absolute -bottom-[2px] inset-x-0 h-[3px] bg-white z-30"></div>
                    </button>
                </nav>
            </div>
