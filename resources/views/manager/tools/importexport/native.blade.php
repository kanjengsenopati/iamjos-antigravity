...
@section('content')
    <div x-data="nativeXmlPlugin()" class="space-y-6">
        ...
        <div class="bg-white rounded-[24px] shadow-sm border-2 border-[#DAD8F4] overflow-hidden">
            ...
            {{-- TABS NAVIGATION (Seamless Door Style - Robust Fix) --}}
            <div class="relative border-b-2 border-[#DAD8F4]">
                <nav class="flex -mb-[2px] px-6">
                    <button @click="tab = 'import'"
                        :class="tab === 'import' ?
                            'border-[#DAD8F4] text-indigo-600 bg-white rounded-t-[20px] border-t-2 border-l-2 border-r-2 z-20' :
                            'border-transparent text-slate-400 hover:text-slate-600'"
                        class="relative flex-1 md:flex-none whitespace-nowrap py-4 px-8 font-bold text-sm flex items-center justify-center gap-2 transition-all duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                 d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path>
                        </svg>
                        Import
                        <div x-show="tab === 'import'" class="absolute -bottom-[2px] inset-x-0 h-[4px] bg-white z-30"></div>
                    </button>
                    <button @click="tab = 'articles'"
                        ...
                        Export Articles
                        <div x-show="tab === 'articles'" class="absolute -bottom-[2px] inset-x-0 h-[4px] bg-white z-30"></div>
                    </button>
                    <button @click="tab = 'issues'"
                        ...
                        Export Issues
                        <div x-show="tab === 'issues'" class="absolute -bottom-[2px] inset-x-0 h-[4px] bg-white z-30"></div>
                    </button>
                </nav>
            </div>
