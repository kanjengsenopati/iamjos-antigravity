...
@section('content')
    <div x-data="articleDashboard()" x-init="initDashboard()" class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <div class="flex items-start justify-between relative z-10">
                        <div class="flex-1">
                            ...
                            <div class="text-3xl font-bold text-slate-800 text-center" x-text="formatNumber(kpi.views)">0</div>
                        </div>
                ...
                <div
                    ...
                    <div class="flex items-start justify-between relative z-10">
                        <div class="flex-1">
                            ...
                            <div class="text-3xl font-bold text-slate-800 text-center" x-text="formatNumber(kpi.downloads)">0</div>
                        </div>
                        <div class="w-12 h-12 rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform"
                ...
                <div
                    ...
                    <div class="flex items-start justify-between relative z-10">
                        <div class="flex-1">
                            ...
                            <div class="text-2xl font-bold text-slate-800 text-center" x-text="kpi.top_country?.name || '-'">-</div>
                ...
                <div
                    ...
                    <div class="flex items-start justify-between relative z-10">
                        <div class="flex-1">
                            ...
                            <div class="text-lg font-bold text-slate-800 text-center" x-text="kpi.busiest_day?.formatted || '-'">-</div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <template x-for="(row, index) in tableData" :key="row.id">
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-full"
                                            :style="index < 3 ?
                                                'background: linear-gradient(135deg, #fbbf24 0%, #f97316 100%); color: white; font-weight: bold;' :
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <span class="font-mono font-bold text-blue-600 text-base"
                                            x-text="formatNumber(row.views)"></span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <span class="font-mono font-bold text-orange-600 text-base"
                                            x-text="formatNumber(row.downloads)"></span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="h-8 w-full flex items-end gap-px">
                                            <template x-for="(val, i) in row.sparkline" :key="i">
                                                <div class="flex-1 bg-blue-400 rounded-t sparkline-bar hover:bg-blue-600"
                            ...
                            <template x-if="tableData.length === 0 && !isLoading">
                                <tr>
        ...
        function articleDashboard() {
            return {
                ...
                initChart() {
                    ...
                    this.chartInstance = new ApexCharts(document.querySelector("#mainChart"), options);
                ...
                updateChart() {
                    ...
                    this.chartInstance.updateOptions({
                        xaxis: {
                            ...
                            labels: {
                                rotateAlways: this.chartData.categories.length > 15
                            }
                        }
                    });
                ...
                updateMap() {
                    ...
                    // jsVectorMap doesn't have a clean update method, so we need to recreate
                    const mapEl = document.querySelector('#worldMap');
                    if (!mapEl) return;
                ...
                // Helper: Get top 10 countries from map data
                getTopMapData() {
                ...
                // Helper: Get percentage for bar width
                getPercentage(count) {
                    const max = Math.max(...Object.values(this.mapData), 1);
                    return (count / max) * 100;
                },

                // Helper: Get sparkline bar height
