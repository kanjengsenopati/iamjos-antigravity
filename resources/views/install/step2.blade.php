...
<div class="space-y-8" x-data="databaseSetup()">
    <div>
        <h2 class="text-xl font-bold text-gray-800">Database Configuration</h2>
        <p class="text-gray-500 text-sm mt-1">Enter your PostgreSQL database connection details. We highly recommend testing the connection before proceeding.</p>
    </div>
