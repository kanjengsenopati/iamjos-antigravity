...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Total Journals -->
        <div class="bg-white rounded-[24px] border border-slate-100 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-md transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400 bg-slate-50 px-2 py-1 rounded-lg">Total hosted journals</span>
            </div>
            <div class="text-center">
                <p class="text-4xl font-bold text-indigo-600 mb-1">{{ $journals->count() }}</p>
                <p class="text-xs font-semibold uppercase tracking-wider text-slate-500">Journals</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[24px] border border-slate-100 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-md transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400 bg-slate-50 px-2 py-1 rounded-lg">Active journals</span>
            </div>
            <div class="text-center">
                <p class="text-4xl font-bold text-emerald-600 mb-1">{{ $journals->where('enabled', true)->count() }}</p>
                <p class="text-xs font-semibold uppercase tracking-wider text-slate-500">Active</p>
            </div>
        </div>

        <!-- Total Submissions -->
        <div class="bg-white rounded-[24px] border border-slate-100 p-6 shadow-[0_8px_30_rgb(0,0,0,0.04)] hover:shadow-md transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400 bg-slate-50 px-2 py-1 rounded-lg">Total submissions</span>
            </div>
            <div class="text-center">
                <p class="text-4xl font-bold text-blue-600 mb-1">{{ $journals->sum('submissions_count') }}</p>
                <p class="text-xs font-semibold uppercase tracking-wider text-slate-500">Articles</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[24px] border border-slate-100 p-6 shadow-[0_8px_30_rgb(0,0,0,0.04)] hover:shadow-md transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-[10px] font-bold uppercase tracking-widest text-slate-400 bg-slate-50 px-2 py-1 rounded-lg">Published issues</span>
            </div>
            <div class="text-center">
                <p class="text-4xl font-bold text-purple-600 mb-1">{{ $journals->sum('issues_count') }}</p>
