...
@section('content')
    <!-- Page Header -->
    <div class="mb-6">
        <h1 class="text-[22px] font-bold text-slate-900 tracking-tight leading-none">Site Administration</h1>
        <p class="text-sm text-slate-500 mt-1.5 leading-tight">Manage your IAMJOS installation, journals, and system settings.</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-[24px] border border-slate-100 p-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div class="flex items-center justify-center gap-2 mb-3">
                ...
                <span class="text-[13.5px] font-bold tracking-widest text-slate-400 bg-slate-50 px-2 py-0.5 rounded-md">Total Journals</span>
            </div>
        ...
        <div class="bg-white rounded-[24px] border border-slate-100 p-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div class="flex items-center justify-center gap-2 mb-3">
                ...
                <span class="text-[13.5px] font-bold tracking-widest text-slate-400 bg-slate-50 px-2 py-0.5 rounded-md">Active Journals</span>
            </div>
            <div class="text-center">
        ...
        <div class="bg-white rounded-[24px] border border-slate-100 p-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div class="flex items-center justify-center gap-2 mb-3">
                ...
                <span class="text-[13.5px] font-bold tracking-widest text-slate-400 bg-slate-50 px-2 py-0.5 rounded-md">Total Submissions</span>
            </div>
            <div class="text-center">
        ...
        <div class="bg-white rounded-[24px] border border-slate-100 p-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div class="flex items-center justify-center gap-2 mb-3">
                ...
                <span class="text-[13.5px] font-bold tracking-widest text-slate-400 bg-slate-50 px-2 py-0.5 rounded-md">Published Issues</span>
            </div>
            <div class="text-center">
