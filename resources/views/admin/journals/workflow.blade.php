                    ...
                    <form action="{{ route('journal.settings.workflow.update', ['journal' => $journal->slug]) }}"
                        ...
                        <div class="space-y-10">
                            ...
                            <div>
                                ...
                                <textarea name="author_guidelines" rows="10"
                                    ...
                                    placeholder="Enter detailed guidelines for authors...">{{ old('author_guidelines', $journal->author_guidelines) }}</textarea>
                            </div>
                                                    ...
                                                    <td class="px-4 py-4">
                                                        ...
                                                        @if ($form->description)
                                                            <p class="text-xs text-gray-500 mt-0.5">
                                                                {{ Str::limit($form->description, 50) }}</p>
                                                        @endif
                                                    </td>
