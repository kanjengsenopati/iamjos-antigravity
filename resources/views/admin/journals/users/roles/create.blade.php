...
@section('title', $isId ? 'Buat Peran' : 'Create Role')

@section('content')
<div class="mb-8">
    <x-text.h1>{{ $isId ? 'Buat Peran Baru' : 'Create New Role' }}</x-text.h1>
    <x-text.body class="text-slate-500 mt-1">{{ $isId ? 'Tentukan properti, tingkat izin, dan akses alur kerja untuk peran ini.' : 'Define properties, permission levels, and workflow access for this role.' }}</x-text.body>
</div>
