            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden h-full">
                        ...
                        <div class="p-4 bg-gray-50/50 h-full">
                            @error('roles')
                            ...
                            <div class="space-y-2">
                                @foreach ($roles as $role)
                                    ...
                                    @endphp
                                    <label
                                        class="relative flex items-center p-3 rounded-lg border border-gray-200 bg-white hover:border-indigo-300 cursor-pointer transition-all shadow-sm group">
