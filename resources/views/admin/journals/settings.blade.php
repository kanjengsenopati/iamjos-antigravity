                    ...
                    <form action="{{ route('journal.settings.update', ['journal' => $journal->slug]) }}" method="POST">
                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mb-6">Describe your journal for readers and authors.</p>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="summary" id="summary" rows="4"
                                            placeholder="A brief summary of the journal's scope and mission..." class="w-full">{{ old('summary', $mastheadSettings['summary'] ?? '') }}</textarea>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <div
                                                class="absolute top-0 left-0 right-0 bg-gray-50 border-b border-gray-200 rounded-t-lg px-3 py-2 flex gap-2">
                                                <button type="button"
                                            ...
                                            <textarea name="editorial_team" id="editorial_team" rows="6"
                                                placeholder="List your editorial board members and their roles..." class="w-full pt-12"
                                                style="padding-top: 3rem;">{{ old('editorial_team', $mastheadSettings['editorial_team'] ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <textarea name="about" id="about" rows="8"
                                                placeholder="Full description of the journal, its history, aims and scope, editorial policies..."
                                                class="w-full pt-12" style="padding-top: 3rem;">{{ old('about', $mastheadSettings['about'] ?? '') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
