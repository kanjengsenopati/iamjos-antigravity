                ...
                <form action="{{ route('journal.settings.update', ['journal' => $journal->slug]) }}" method="POST">
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mb-6">Describe your journal for readers and authors. Rich text formatting is supported.</p>
                            ...
                            <div class="space-y-6">
                                ...
                                <!-- About the Journal -->
                                <div>
                                    <label for="about" class="block text-sm font-medium text-gray-700 mb-1">About the Journal</label>
                                    <textarea name="about" id="about" rows="8" class="tinymce-editor w-full">{{ old('about', $mastheadSettings['about'] ?? '') }}</textarea>
                                    <p class="mt-1 text-xs text-gray-500">Full description of the journal, its history, aims and scope, editorial policies.</p>
                                </div>

                                <!-- Editorial Team -->
                                <div>
                                    <label for="editorial_team" class="block text-sm font-medium text-gray-700 mb-1">Editorial Team Description</label>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">List your editorial board members and their roles.</p>
                                </div>
                            </div>
                        </div>
                    </div>
