...
@section('content')
    ...
    <!-- Welcome Card -->
    <div class="mb-8">
        <div class="bg-indigo-700 rounded-2xl shadow-lg overflow-hidden">
            <div class="px-6 py-8 sm:px-8 sm:py-10 flex flex-col sm:flex-row items-start sm:items-center justify-between">
