@php $title = __('About the Journal'); @endphp

<x-layouts.public :journal="$journal" :settings="$settings" :title="$title">

    <section class="bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <h1 class="text-3xl font-bold text-gray-900 mb-8">{{ __('About the Journal') }}</h1>
            ...
            <div class="text-center py-12">
                <div class="text-gray-500">
                    ...
                    <p>{{ __('About content has not been configured yet.') }}</p>
                </div>
            </div>
            @endif
        </div>
