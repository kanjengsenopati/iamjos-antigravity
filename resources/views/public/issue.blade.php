            ...
            <div class="grid lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-3">
                    <nav class="text-sm text-gray-500 mb-4">
                        <a href="{{ route('journal.public.archives', ['journal' => $journal->slug]) }}" class="hover:text-primary-600">Archives</a>
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="space-y-8">
                                ...
                                <div class="flex flex-col md:flex-row gap-4 border-b border-gray-100 pb-6 last:border-0">
                                                ...
                                                @foreach($article->authors as $author)
                                                    <div class="text-sm text-gray-700">
                                                        ...
                                                        @if($author->affiliation)
                                                            <span class="text-gray-500">, {{ $author->affiliation }}</span>
                                                        @endif
                                                        @if($author->country)
