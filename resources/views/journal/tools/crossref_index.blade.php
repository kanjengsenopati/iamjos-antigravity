        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 overflow-hidden">
            ...
            <div class="relative">
                ...
                <nav class="relative flex">
                    <a href="?tab=settings"
                        class="relative z-10 flex-1 md:flex-none whitespace-nowrap py-4 px-8 font-bold text-sm flex items-center justify-center gap-2 transition-all duration-200 -mb-[1px] {{ $tab === 'settings' ? 'border-[#DAD8F4] text-indigo-600 bg-white rounded-t-2xl border-t border-l border-r' : 'border-transparent text-slate-400 hover:text-slate-600 hover:bg-slate-50/50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        Settings
                        @if($tab === 'settings') <div class="absolute -bottom-[1px] inset-x-0 h-[2px] bg-white z-20"></div> @endif
                    </a>
                    <a href="?tab=articles"
                        class="relative z-10 flex-1 md:flex-none whitespace-nowrap py-4 px-8 font-bold text-sm flex items-center justify-center gap-2 transition-all duration-200 -mb-[1px] {{ $tab === 'articles' ? 'border-[#DAD8F4] text-indigo-600 bg-white rounded-t-2xl border-t border-l border-r' : 'border-transparent text-slate-400 hover:text-slate-600 hover:bg-slate-50/50' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        Articles
                        @if($tab === 'articles') <div class="absolute -bottom-[1px] inset-x-0 h-[2px] bg-white z-20"></div> @endif
                    </a>
                </nav>
            </div>
