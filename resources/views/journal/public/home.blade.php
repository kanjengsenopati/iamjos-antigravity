    ...
    <div>
        <div class="w-full">
            ...
            <section class="mb-8">
                ...
                <div class="flex flex-col md:flex-row gap-6 mb-10 bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    ...
                    <div class="flex-shrink-0">
                        ...
                        @else
                        <div class="w-48 h-64 bg-slate-100 flex items-center justify-center text-slate-400 rounded border border-slate-200 mx-auto md:mx-0">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="text-2xl font-bold text-slate-900 mb-3 leading-tight">
                            Vol. {{ $currentIssue->volume }} No. {{ $currentIssue->number }} ({{ $currentIssue->year }})@if($currentIssue->title): {{ $currentIssue->title }}@endif
                        </h3>
                ...
                @php
                $issueArticles = $currentIssue->submissions()
                    ->where('status', 'published')
                    ->with(['authors', 'galleys'])
                    ->orderBy('created_at')
                    ->get();
                @endphp
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    <h3 class="text-xl font-bold text-slate-700 border-b border-slate-200 pb-2 mb-6">Articles</h3>
