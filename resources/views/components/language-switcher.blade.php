...
@if($inline)
    <div x-data="{ open: false }" class="relative inline-block text-left">
        <button @click="open = !open" type="button"
            ...
            <span class="text-sm leading-none">{{ app()->getLocale() === 'id' ? '🇮🇩' : '🇬🇧' }}</span>
        ...
        <div x-show="open" 
            ...
            <a href="{{ route('locale.switch', 'id') }}" 
                class="flex items-center gap-2.5 px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors {{ app()->getLocale() === 'id' ? 'bg-slate-50 text-indigo-600' : '' }}">
            ...
            <a href="{{ route('locale.switch', 'en') }}" 
                class="flex items-center gap-2.5 px-4 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors {{ app()->getLocale() === 'en' ? 'bg-slate-50 text-indigo-600' : '' }}">
                <span class="text-sm leading-none">🇬🇧</span>
