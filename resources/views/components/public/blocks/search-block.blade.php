...
<form action="{{ route('journal.public.search', $journal->slug) }}" method="GET">
    ...
    <button type="submit" 
        class="w-full mt-2 px-4 py-2 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-lg transition-colors">
        Search
    </button>
</form>
