...
<div x-data="{ activeTab: 'all' }" class="min-h-screen bg-slate-50 pb-20">
    ...
    <div class="bg-white border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12">
            ...
            {{-- Search Form --}}
            <div class="mt-6">
                <form id="searchForm" method="GET" action="{{ route('portal.search') }}" class="flex flex-col sm:flex-row gap-3">
                    <div class="flex-1">
                        <input type="text"
                               name="q"
                               value="{{ $query }}"
            ...
            <div class="border-b border-slate-200">
                <nav class="flex">
                    <button @click="activeTab = 'all'"
                            :class="activeTab === 'all' ? 'border-blue-500 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300'"
                    ...
                    <button @click="activeTab = 'journals'"
                            :class="activeTab === 'journals' ? 'border-blue-500 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300'"
                            class="flex-1 py-4 px-1 text-center border-b-2 font-medium text-sm transition-colors">
                        Jurnal ({{ $journals->count() }})
                    </button>
                    <button @click="activeTab = 'articles'"
                            :class="activeTab === 'articles' ? 'border-blue-500 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300'"
                            class="flex-1 py-4 px-1 text-center border-b-2 font-medium text-sm transition-colors">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-slate-900 truncate">
                                            <a href="{{ route('journal.home', $journal->slug) }}" class="hover:text-blue-600">
                                                {{ $journal->name }}
                                            </a>
                                        </h4>
