<div class="app-navbar d-flex justify-content-between">
    ...
    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
        ...
        <!--begin::Menu- wrapper-->
        {{-- <div>
            <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px rounded-circle"
                data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                data-kt-menu-placement="bottom-end" id="kt_menu_item_wow">
    ...
    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
            ...
            <img src="{{ asset(Auth::user()->avatar ?? 'assets/media/avatars/default.jpg') }}" class="rounded-circle"
                alt="user" />
        </div>
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <img alt="Logo"
                            src="{{ asset(Auth::user()->avatar ?? 'assets/media/avatars/default.jpg') }}" />
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Username-->
            ...
            <div class="menu-item px-5">
                <a href="{{ route('profile-admin.edit') }}" class="menu-link px-5">Profile</a>
            </div>
            <!--end::Menu item-->
            <!--end::Menu item-->
            {{-- @if (Auth::user()->is_head_office)
            <div class="menu-item px-5">
                <a href="{{ route('head-office.access-menu') }}" class="menu-link px-5">Move to Head Office</a>
            </div>
            @endif --}}
            <!--end::Menu item-->
